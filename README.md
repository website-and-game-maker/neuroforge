...
entire ML engine (matrices, dense layers, activations, losses, backpropagation, and the
optimizers — SGD with momentum, and Adam) is implemented by hand in TypeScript — **no ML
...
layer? why do two spirals need depth?), switch the optimizer mid-run to feel what an
adaptive step size buys you, or play freely in the sandbox.
